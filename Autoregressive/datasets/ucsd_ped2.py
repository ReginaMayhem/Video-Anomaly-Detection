from glob import glob #matching pattern
from os.path import basename # path = '/home/User/Documents' basename will be Documents
from os.path import isdir
from os.path import join
from typing import List #def greeting(name: str) -> str:
...
class UCSDPed2(VideoAnomalyDetectionDataset):
    ...
    def load_test_ids(self):
        ...
        '**' will return all levels below test_dir
        """
    ...
    def load_test_sequence_gt(self, video_id):
        ...
        clip_gt = []
        for img_path in img_list:
            img = io.imread(img_path) // 255 #img_arrayndarray//255, thus whole range is between [0,1]
